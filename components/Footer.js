const Footer = () => (
    <footer className="w-full bg-white px-6 border-t">
		<div className="container mx-auto max-w-4xl py-6 flex flex-wrap md:flex-no-wrap justify-between items-center text-sm text-center">
			©2019 Teofilus Candra. Built with NextJS and Tailwind CSS.
			<div className="flex justify-center lg:justify-start w-full lg:w-auto items-center text-gray-500">
